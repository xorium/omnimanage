...
func (r *LocationRepo) ReplaceRelation(ctx context.Context, id int, relationName string, relationData interface{}) error {
	db := r.db.WithContext(ctx)
...
func (r *LocationRepo) AppendRelation(ctx context.Context, id int, relationName string, relationData interface{}) error {
	db := r.db.WithContext(ctx)
...
func (r *LocationRepo) DeleteRelation(ctx context.Context, id int, relationName string, relationData interface{}) error {
	db := r.db.WithContext(ctx)
